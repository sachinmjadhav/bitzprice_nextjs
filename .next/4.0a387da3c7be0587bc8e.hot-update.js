  ...
  _createClass(Prices, [{
    ...
    value: function render() {
      ...
      if (this.state.currency === "USD") {
        desc = bpi.USD.description;
        code = bpi.USD.code;
        rate = bpi.USD.rate;
      } else if (this.state.currency === "GBP") {
        desc = bpi.GBP.description;
        code = bpi.GBP.code;
        rate = bpi.GBP.rate;
      } else if (this.state.currency === "EUR") {
        desc = bpi.EUR.description;
        code = bpi.EUR.code;
        rate = bpi.EUR.rate;
      }
      ...
      }, "Bitcoin rate for ", desc, " :", " ", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", {
        className: "badge badge-primary",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        }
      }, code), " ", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("strong", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 34
        }
      }, rate))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 37
        }
...
//# sourceMappingURL=4.0a387da3c7be0587bc8e.hot-update.js.map